...
$my_email = "jowaljones@gmail.com, hello@lukorito.dev";
...
/* Subject line */
$subject = "Contact from Lukorito.dev";

/* Site URL */
$site_url = "https://lukorito.dev";

/* Site Name */
$site_name = "Lukorito.dev";
...
// Display any errors and exit if errors exist more than 1
...
<head>
	...
	<title>Thank you for contacting Lukorito</title>
	<style>
		body 		{font-family:Arial, sans-serif; font-size:13px;}
		p 			{line-height:1.5em;}
		#thankyou 	{margin:200px auto 0px; width:400px; background:#3393FF; border:1px solid ##FFA500; padding:20px;
